...
(defun detect-configs (&key (name ".likit") (folders '(#p"~/Sync/")))
  "Detect configs"
...
(defun load-configs (&key (name ".likit") folders)
  "Load configs"
...
(defun get-config (key &key (name ".likit") test)
  (let ((results
...
(defun set-config (key value &rest args &key (section ".likit") (folder #p"."))
